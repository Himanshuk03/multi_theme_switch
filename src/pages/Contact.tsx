...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: '📧',
      title: 'Email Us',
      description: 'support@themeswitcher.com',
      aos: 'fade-down',
    },
    {
      icon: '📞',
    ...
    },
    {
      icon: '🏢',
      title: 'Visit Us',
      description: 'Rajasthan Technical University, Kota',
      aos: 'fade-right',
    },
  ];
  ...
  return (
    <div className="mt-24 px-6 sm:px-6 lg:px-10 text-[var(--text-color)]">
      ...
      {/* Contact Info done in Cards */}
      <div className="flex flex-wrap justify-center gap-x-6 gap-y-10">
        {contactInfo.map((item, index) => (
          <div
            key={index}
            data-aos="fade-right"
            className="bg-white dark:bg-gray-800 w-[300px] p-5 rounded-lg shadow-md
